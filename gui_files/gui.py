...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(10, -10, 250, 40))
        ...
        self.loadCertificates.setGeometry(QtCore.QRect(340, 190, 301, 41))
        self.loadCertificates.setObjectName("loadCertificates")
        self.LoggingBrowser = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.LoggingBrowser.setGeometry(QtCore.QRect(10, 30, 321, 321))
        self.LoggingBrowser.setObjectName("LoggingBrowser")
        self.ClientServerFrame = QtWidgets.QFrame(self.centralwidget)
        self.ClientServerFrame.setGeometry(QtCore.QRect(340, 290, 301, 61))
        self.ClientServerFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.ClientServerFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.ClientServerFrame.setObjectName("ClientServerFrame")
        self.gridLayoutWidget = QtWidgets.QWidget(self.ClientServerFrame)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 301, 61))
        ...
        font.setBold(True)
        font.setWeight(75)
        self.ServerInfo.setFont(font)
        self.ServerInfo.setStyleSheet("color:green")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.ClientInfo.setFont(font)
        self.ClientInfo.setStyleSheet("color: green")
        ...
        self.MessageBrowser = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.MessageBrowser.setEnabled(True)
        self.MessageBrowser.setGeometry(QtCore.QRect(340, 30, 301, 151))
        self.MessageBrowser.setReadOnly(True)
        self.MessageBrowser.setObjectName("MessageBrowser")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(340, -10, 250, 40))
